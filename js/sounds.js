...
window.SFX = (function () {
  ...
  const C = {
    ...
    keese()           { tone(2200,0.03,'sine',0.40); tone(1900,0.03,'sine',0.36,0.05); tone(2100,0.03,'sine',0.38,0.10); },
    navi()            { tone(1047,0.28,'sine',0.44); tone(1319,0.16,'triangle',0.28,0.06); },
    ...
    cat()             { tone(340,0.10,'sine',0.38); glide(380,680,0.20,'sine',0.45,0.08); glide(680,240,0.30,'sine',0.42,0.28); },
    bee()             { tone(200,0.45,'sawtooth',0.40); tone(302,0.45,'sawtooth',0.18,0.01); },
